...
<html lang="en">
  ...
  <body>
    <div class="col-xs-12 col-md-4 col-md-offset-4 terms">
          <div class="terms-logo"><center>PASAR <img src="images/logoolx.png"></center></div>
          <div class="terms-title"><center>Mohon dibaca terlebih dahulu</center></div>
          <div class="terms-text"><center>Mohon dibaca terlebih dahulu</center></div>
          <div class="terms-button"><a href="form.php">DAFTAR SEKARANG</a></div>
